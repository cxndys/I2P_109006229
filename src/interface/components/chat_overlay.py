...
class ChatOverlay(UIComponent):
    ...
    def __init__(
        ...
        *,
        ...
        # TODO
        try:
            self._font_msg = pg.font.Font(font_path, 15)
            self._font_input = pg.font.Font(font_path, 15)
        except Exception:
            self._font_msg = pg.font.SysFont("Arial", 15)
            self._font_input = pg.font.SysFont("Arial", 15)
